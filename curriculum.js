(function (root, factory) {
  ...
  const sourceManifest = {
    ...
    sources: [
      ...
      { sourceId: 'pdf:section-1-1-annotated', sectionId: '1-1', kind: 'teacher-pdf', title: 'Section 1.1 - Points, Lines, and Planes - annotated' },
      { sourceId: 'canvas:1-3', sectionId: '1-3', kind: 'canvas-published', title: '1-3 Midpoint and Distance Formulas' },
      { sourceId: 'pdf:section-1-3-annotated', sectionId: '1-3', kind: 'teacher-pdf', title: 'Section 1.3 - Midpoint and Distance Formula - annotated' },
      ...
      { sourceId: 'pdf:section-1-5-measuring-angles-annotated', sectionId: '1-5', kind: 'teacher-pdf', title: 'Section 1.5 - Measuring Angles - annotated' },
      { sourceId: 'pdf:section-1-5-more-measuring-angles-annotated', sectionId: '1-5', kind: 'teacher-pdf', title: 'Section 1.5 - More Measuring Angles - annotated' },
      { sourceId: 'canvas:1-6', sectionId: '1-6', kind: 'canvas-published', title: '1-6 Angle Relationships' },
      { sourceId: 'pdf:section-1-6-pairs-of-angles-annotated', sectionId: '1-6', kind: 'teacher-pdf', title: 'Section 1.6 - Pairs of Angles - annotated' },
      { sourceId: 'canvas:2-2', sectionId: '2-2', kind: 'canvas-published', title: '2-2 Inductive and Deductive Reasoning' },
      { sourceId: 'pdf:section-2-2-inductive-deductive-annotated', sectionId: '2-2', kind: 'teacher-pdf', title: 'Section 2.2 - Inductive and Deductive Reasoning - annotated' },
